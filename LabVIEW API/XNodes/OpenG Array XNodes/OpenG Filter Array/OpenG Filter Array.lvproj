...
<Project Type="Project" LVVersion="8608001">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="OpemG Filter Array" Type="Folder">
			<Item Name="OpenG FilterArray.xnode" Type="XNode" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG FilterArray.xnode"/>
		...
		<Item Name="Scripting Tools.lvlib" Type="Library" URL="/&lt;userlib&gt;/LAVACR/8.6.x/Rusty Nails/VI Scripting/Scripting Tools/Scripting Tools.lvlib"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="user.lib" Type="Folder">
				<Item Name="Find Tagged and Move.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/Rusty Nails/VI Scripting/Scripting Tools/Tags/Find Tagged and Move.vi"/>
				<Item Name="Wire XNode Terms by Tag.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/Rusty Nails/VI Scripting/Scripting Tools/Public/Wire XNode Terms by Tag.vi"/>
				<Item Name="OpenG Array filter - Scalar Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Scalar Template.vi"/>
				<Item Name="OpenG Array filter - Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Template.vi"/>
				<Item Name="OpenG Array filter -Invert  Scalar Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter -Invert  Scalar Template.vi"/>
				<Item Name="OpenG Array filter - Invert Array Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Invert Array Template.vi"/>
				<Item Name="OpenG Array filter - Scalar Regexp Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Scalar Regexp Template.vi"/>
				<Item Name="OpenG Array filter - Regexp Array Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Regexp Array Template.vi"/>
				<Item Name="OpenG Array filter -Regexp Invert  Scalar Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter -Regexp Invert  Scalar Template.vi"/>
				<Item Name="OpenG Array filter - Regexp Invert Array Template.vi" Type="VI" URL="/&lt;userlib&gt;/LAVACR/8.6.x/LabVIEW API/XNodes/Array XNodes/OpenG Filter Array/OpenG Array filter - Regexp Invert Array Template.vi"/>
			</Item>
		</Item>
